...
void GUIRestoreVars()
{
  ...
  CheckValueBounds(&NativeFilePicker, 0, 1, 0, UB);
  CheckValueBounds(&EmulateSavestates, 0, 1, 0, UB);
  ...
  CheckValueBounds(&GrayscaleMode, 0, 3, 0, UB);
  ...
  CheckValueBounds(&RewindType, 0, 1, 0, UB);
  CheckValueBounds(&RewindStates, 1, 9999, 300, UD);
